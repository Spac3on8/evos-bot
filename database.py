...
def insert_products_table():
    ...
    (1, 'Achchiq tovuq', 26000, 'Tovuq goshtli sirli sochni pamidor bodring', 'media/lavash/tovuq_achchiq_lavash.jpg'),
    ...
    (2, 'Burger', 22000, 'Mol go`shtli burger', 'media/burger/Burger.jpg'),
    (2, 'Chizburger', 24000, 'Mol go`shtli sirli burger', 'media/burger/Chizburger.jpg'),
    (2, 'Doubleburger', 26000, 'Ikki hissa katta mol go`shtli burger', 'media/burger/Dublburger.jpg'),
    (2, 'Doublechizburger', 28000, 'Ikki hissa katta mol go`shtli sirli burger', 'media/burger/Dublchizburger.jpg'),
    (3, 'Xot-dog detskiy', 18000, 'Bolalar uchun xot-dog', 'media/xot-dog/detskiy.jpg'),
    (3, 'Double xot-dog', 25000, 'Ikki hissa katta xot-dog', 'media/xot-dog/dubl_xot-dog.jpg'),
    (3, 'Mini xot-dog', 20000, 'Mini katta xot-dog', 'media/xot-dog/mini-xotdog.jpg'),
    (3, 'Xot-dog', 21000, 'Obichniy xot-dog', 'media/xot-dog/xot-dog.jpg'),
    (4, 'Shaurma mol go`shtli', 25000, 'Mol go`shtli, pomidor, bodring', 'media/shaurma/mol_goshtli_shaurma.jpg'),
    (4, 'Achchiq mol go`shtli shaurma', 26000, 'Mol go`shtli, pomidor, bodring, qalampir', 'media/shaurma/achchiq_mol_gosht.jpg'),
    (4, 'Shaurma tovuq go`shtli', 24000, 'Tovuq go`shti, pomidor, bodring', 'media/shaurma/tovuqli_shaurma.jpg'),
    (4, 'Achchiq tovuq go`shtli shaurma', 25000, 'Tovuq go`shti, pomidor, bodring, qalampir', 'media/shaurma/achchiq_tovuqli_shaurma.jpg'),
    (5, 'Mol go`shtli sab', 18000, 'Mol go`shti, piyoz, sous', 'media/sab/mol_goshtli_sab.jpg'),
    (5, 'Mol go`shtli sirli sab', 20000, 'Mol go`shti, piyoz, sous, sir', 'media/sab/mol_goshtli_sirli_sab.jpg'),
    (5, 'Tovuq go`shtli sab', 17000, 'Tovuq go`shti, piyoz, sous', 'media/sab/sab_tovuqli.jpg'),
    (5, 'Tovuq go`shtli sirli sab', 19000, 'Tovuq go`shti, piyoz, sous, sir', 'media/sab/tovuqli_sirli_sab.jpg'),
    (6, 'Montella', 5000, 'Suv', 'media/colddrink/bez-gaz suv.jpg'),
    (6, 'Bliss', 15000, 'Sok', 'media/colddrink/bliss sok.jpg'),
    (6, 'Moxito', 10000, 'razliv', 'media/colddrink/moxito.jpg'),
    (6, 'Pepsi', 12000, '1.5 litr', 'media/colddrink/pepsi 1.5.jpg'),
    (6, 'Pepsi razliv', 8000, 'razliv', 'media/colddrink/pepsi-razliv.jpg'),
    (7, 'Fri', 8000, 'Oddiy fri', 'media/kartoshka/fri.jpg'),
    (7, 'Kartoshka derenvenski', 12000, 'Derevenski fri', 'media/kartoshka/derevenski_kartoshka.jpg'),
    (8, 'Cheescake', 14000, 'Chernikali cheescake', 'media/desert/cheescake.jpg'),
    (8, 'Ponchik', 10000, 'Karamelli ponchik', 'media/desert/donat karamelni.jpg'),
    (8, 'Ponchik meva', 10000, 'Mevali ponchik', 'media/desert/yagodniy-donat.jpg'),
    (8, 'Medovik', 11000, 'Oddiy medovik', 'media/desert/medovik.jpg')
    ''')
    database.commit()
    database.close()
